...
<template>
  <div class="qr-code-container">
    ...
    <div class="qr-code-wrapper">
      <img :src="qrCode" alt="支付二维码" class="qr-code-image" />

      <!-- 扫描动画 -->
      <div v-if="status === 'pending'" class="scan-animation">
        <!-- 扫描线 -->
      ...
      <!-- 已扫描遮罩 -->
      <div v-else-if="status === 'scanned'" class="scanned-overlay">
      ...
      <!-- 支付中遮罩 -->
      <div v-else-if="status === 'paid'" class="paying-overlay">
